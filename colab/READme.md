...
- `2025-03-25 0000 2h`: Folder containing ERA5 data used up till `07_lead0_rmse_sanity_check.ipynb`.
- `2025-11-27 0600 12h`: Folder containing ERA5 data used for `08_rmse.ipynb`.
- `stormcast_output_era5_12h.zarr`: 12h lead time inference generated by `08_rmse.ipynb`.
